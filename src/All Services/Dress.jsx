...
export default function Dress() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Dress Rent Service</h1>
            <hr />
            <div className='details-description'>Looking to rent a dress? Here are details for the ones in Vidisha.</div>
