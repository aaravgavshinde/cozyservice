...
export default function Cooler() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Cooler Rent Service</h1>
            <hr />
            <div className='details-description'>Looking to rent a cooler? Here are details for the ones in Vidisha.</div>
