...
export default function Room() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Room Rent Service</h1>
            <hr />
            <div className='details-description'>Looking to rent a room? Here are details for the ones in Vidisha.</div>
