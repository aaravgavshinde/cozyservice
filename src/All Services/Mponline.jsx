...
export default function Mponline() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>MP Online Nearby</h1>
            <hr />
            <div className='details-description'>Looking for a MP Online nearby? Here are details for the ones in Vidisha.</div>
