...
export default function Carpenter() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Carpenter Service</h1>
            <hr />
            <div className='details-description'>Looking for a carpenter to work at your home? Here are details for the ones in Vidisha.</div>
