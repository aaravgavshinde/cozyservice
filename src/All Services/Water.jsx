...
export default function Water() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Water Service</h1>
            <hr />
            <div className='details-description'>Looking for a water delivery service at your home? Here are details for the ones in Vidisha.</div>
