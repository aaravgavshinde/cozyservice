...
export default function Maid() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Maid Service</h1>
            <hr />
            <div className='details-description'>Looking for a maid to work at your home? Here are details for the ones in Vidisha.</div>
