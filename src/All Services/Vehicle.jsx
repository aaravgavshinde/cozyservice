...
export default function Vehicle() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Vehicle Rent Service</h1>
            <hr />
            <div className='details-description'>Looking to rent a vehicle? Here are details for the ones in Vidisha.</div>
