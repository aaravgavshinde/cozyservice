...
export default function Painter() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Painter Service</h1>
            <hr />
            <div className='details-description'>Looking for a painter to paint at your home? Here are details for the ones in Vidisha.</div>
