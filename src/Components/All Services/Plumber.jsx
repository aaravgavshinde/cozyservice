...
export default function Plumber() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Plumber Service</h1>
            <hr />
            <div className='details-description'>Looking for a plumber to work at your home? Here are details for the ones in Vidisha.</div>
