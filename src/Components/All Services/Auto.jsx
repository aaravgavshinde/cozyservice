...
export default function Auto() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Auto Rickshaw Nearby</h1>
            <hr />
            <div className='details-description'>Looking for a auto rickshaw nearby? Here are details for the ones in Vidisha.</div>
