...
export default function Doctor() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Doctor Nearby</h1>
            <hr />
            <div className='details-description'>Looking for a doctor nearby? Here are details for the ones in Vidisha.</div>
