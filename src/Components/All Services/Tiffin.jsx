...
export default function Tiffin() {
    ...
    return (
        <div className='details-main-div'>
            ...
            <h1 className='details-heading'>Tiffin Service</h1>
            <hr />
            <div className='details-description'>Looking for a tiffin delivery at your home? Here are details for centers in Vidisha.</div>
